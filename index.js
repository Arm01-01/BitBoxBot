...
┊${chalk.blueBright('┊')}${chalk.cyan(`💚 Nombre: BitBox Bot`)}
┊${chalk.blueBright('┊')}${chalk.cyan(`𓃠 Versión: ${packageJsonObj.version}`)}
┊${chalk.blueBright('┊')}${chalk.cyan(`💜 Descripción: Whatsapp Bot`)}
┊${chalk.blueBright('┊')}${chalk.cyan(`😺 Project Author: Armando (@arm.pg_)`)}
┊${chalk.blueBright('╰┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')} 
┊${chalk.blueBright('╭┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅')}
