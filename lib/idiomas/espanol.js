...
const smsRowner = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO YO COMO CREADOR DE BOT LO PUEDE USAR!!\`\`\`` }//NUMERO DE BOT
const smsOwner = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO MI CREADOR LO PUEDE USAR!!\`\`\`` }//OWNER
const smsMods = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO MODERADORES Y MI CREADOR LO PUEDEN USAR!!\`\`\`\`` }//MODERADORES
const smsPremium = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO ESTA DISPONIBLE PARA USUARIOS PREMIUM Y MI CREADOR!! PARA SER PREMIUM COMPRE UN PASE USANDO #pass premium\`\`\`` }//USUARIOS PREMIUM
...
const smsSetstock = () => { return '╰⊱💚⊱ *ÉXITO* ⊱💚⊱╮\n\n*𝙎𝙀 𝙃𝘼 𝙀𝙎𝙏𝘼𝘽𝙇𝙀𝘾𝙄𝘿𝙊 𝘾𝙊𝙍𝙍𝙀𝘾𝙏𝘼𝙈𝙀𝙉𝙏𝙀 𝙀𝙇 𝙎𝙏𝙊𝘾𝙆 𝘿𝙀 𝙏𝙐𝙎 𝙑𝙀𝙉𝙏𝘼𝙎*'}
const smsSetpagos = () => { return '╰⊱💚⊱ *ÉXITO* ⊱💚⊱╮\n\n*𝙎𝙀 𝙃𝘼 𝙀𝙎𝙏𝘼𝘽𝙇𝙀𝘾𝙄𝘿𝙊 𝘾𝙊𝙍𝙍𝙀𝘾𝙏𝘼𝙈𝙀𝙉𝙏𝙀 𝙏𝙐𝙎 𝙈𝙀𝙏𝙊𝘿𝙊𝙎 𝘿𝙀 𝙋𝘼𝙂𝙊*'}
const smsSetreglas = () => { return '╰⊱💚⊱ *ÉXITO* ⊱💚⊱╮\n\n*𝙎𝙀 𝙃𝘼 𝙀𝙎𝙏𝘼𝘽𝙇𝙀𝘾𝙄𝘿𝙊 𝘾𝙊𝙍𝙍𝙀𝘾𝙏𝘼𝙈𝙀𝙉𝙏𝙀 𝙏𝙐𝙎 𝙍𝙀𝙂𝙇𝘼𝙎*'}
...
//_allantilink.js
const smsTextoYT = () => { return 'BitBox Bot '} 
...
//grupo-setpagos.js
const smsSetP = () => { return `*TU METODO DE PAGO HA SIDO CONFIGURADO CORRECTAMENTE*`}
const smsSetP2 = () => { return `*PARA CONFIGURAR TU METODO DE PAGO EN ESTE GRUPO USA .setpagos`}

//grupo-setstock.js
const smsSetS = () => { return `*TU METODO DE PAGO HA SIDO CONFIGURADO CORRECTAMENTE*`}
const smsSetS2 = () => { return `*PARA CONFIGURAR TU METODO DE PAGO EN ESTE GRUPO USA .setstock`}

//grupo-setreglas.js
const smsSetR = () => { return `*TU METODO DE PAGO HA SIDO CONFIGURADO CORRECTAMENTE*`}
const smsSetR2 = () => { return `*PARA CONFIGURAR TU METODO DE PAGO EN ESTE GRUPO USA .setreglas`}
...
//propietario(a).js
const smsJoin = (user) => { return `${packname}\n𝙀𝙎 𝙐𝙉 𝘽𝙊𝙏 𝘿𝙀 𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋 𝙌𝙐𝙀 𝙏𝙀 𝘼𝙔𝙐𝘿𝘼𝙍𝘼 𝙍𝙀𝘼𝙇𝙄𝙕𝘼𝙍 𝘿𝙄𝙁𝙀𝙍𝙀𝙉𝙏𝙀𝙎 𝘼𝘾𝙏𝙄𝙑𝙄𝘿𝘼𝘿𝙀𝙎 🪄 𝘼𝙇 𝙋𝙍𝙄𝙑𝘼𝘿𝙊 𝙊 𝙂𝙍𝙐𝙋𝙊 𝙔 𝙏𝘼𝙈𝘽𝙄𝙀𝙉 𝙏𝙀 𝙑𝘼𝙎 𝘼 𝘿𝙄𝙑𝙀𝙍𝙏𝙄𝙍 🎈 𝘾𝙊𝙉 𝙎𝙐𝙎 𝙈𝙐𝙇𝙏𝙄𝙋𝙇𝙀𝙎 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙀𝙎!!! 😸\n\n💖 𝙁𝙐𝙀 𝙄𝙉𝙑𝙄𝙏𝘼𝘿𝘼 𝙋𝙊𝙍:\n@${user}`}
...
const smsContacto4 = () => { return 'Contacto Oficial 🐈'}
